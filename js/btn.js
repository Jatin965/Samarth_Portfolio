...
var nameE = document.forms["contact"]["name"].value.length;
var mailE = document.forms["contact"]["mail"].value.length;
var phoneE = document.forms["contact"]["phone"].value.length;
var messageE = document.forms["contact"]["message"].value.length;

console.log("nameE:", nameE);
console.log("mailE:", mailE);
...
clickButton = () => {
  if (
    !disabled /*&& nameE != 0 && mailE != 0 && phoneE != 0 && messageE != 0*/
/*) {
    disabled = true;
    // Loading stage
...
clickButton = () => {
  ...
  if (x == "" || y == "" || z == "" || text === 6) {
    ...
    if (text > 15) {
      ...
      alert("Message must be more than 12 character");
    }
  }
};
